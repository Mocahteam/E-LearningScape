# Téléchargements
**Version 7.1** mise à jour le 01/04/2022

1. [**Windows**](https://github.com/Mocahteam/E-LearningScape/releases/download/v7.1.1/E-LearningScape_Windows.zip)
2. [**MacOS**](https://github.com/Mocahteam/E-LearningScape/releases/download/v7.1.1/E-LearningScape_MacOS.zip)
3. [**Linux**](https://github.com/Mocahteam/E-LearningScape/releases/download/v7.1.1/E-LearningScape_Linux.zip)
