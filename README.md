# Téléchargements
**Version 7.0** disponible depuis le 24/01/2022

1. [**Windows**](https://github.com/Mocahteam/E-LearningScape/releases/download/v7.0/E-LearningScape_Windows.zip)
2. [**MacOS**](https://github.com/Mocahteam/E-LearningScape/releases/download/v7.0/E-LearningScape_MacOS.zip)
3. [**Linux**](https://github.com/Mocahteam/E-LearningScape/releases/download/v7.0/E-LearningScape_Linux.zip)
