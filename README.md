# Téléchargements
**Version 6.5** disponible depuis le 07/10/2021

1. [**Windows**](https://github.com/Mocahteam/E-LearningScape/releases/download/v6.5/E-LearningScape_Windows.zip)
2. [**MacOS**](https://github.com/Mocahteam/E-LearningScape/releases/download/v6.5/E-LearningScape_MacOS.zip)
3. [**Linux**](https://github.com/Mocahteam/E-LearningScape/releases/download/v6.5/E-LearningScape_Linux.zip)
