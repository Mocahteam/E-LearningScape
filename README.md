# Téléchargements
**Version 7.4** mise à jour le 21/05/2025

1. [**Windows**](https://github.com/Mocahteam/E-LearningScape/releases/download/v7.4/E-LearningScape_Windows.zip)
2. [**MacOS**](https://github.com/Mocahteam/E-LearningScape/releases/download/v7.4/E-LearningScape_MacOS.zip)
3. [**Linux**](https://github.com/Mocahteam/E-LearningScape/releases/download/v7.4/E-LearningScape_Linux.zip)
...
Le jeu inclus par défaut trois versions traitant de trois thèmes différents :
   1. Accessibilité et école inclusive ([Accéder à la page web dédiée](https://bepep.inshea.fr/course/view.php?id=15))
   2. Informatique ([Accéder à la page web dédiée](https://www.lip6.fr/Mathieu.Muratet/elearningscape/))
   3. Pédagogie
...
Le jeu E-LearningScape inclus par défaut trois versions traitant de trois thèmes différents (Informatique, Accessibilité et Pédagogie). D'autres versions du jeu existent que vous pouvez télécharger avec les liens ci-dessous. Si vous souhaitez partager votre propre version n'hésitez pas à nous contacter :
   - [Cinema](https://www.lip6.fr/Mathieu.Muratet//elearningscape/Mods/Cinema.zip) (une adaptation sur le cinéma)
   - [DeveloppementDurable](https://www.lip6.fr/Mathieu.Muratet/elearningscape/Mods/DeveloppementDurable.zip) (une adaptation sur le développement durable)
   - [Ecologie](https://www.lip6.fr/Mathieu.Muratet/elearningscape/Mods/Ecologie.zip) (une adaptation sur l'écologie)
   - [EIAH](https://www.lip6.fr/Mathieu.Muratet/elearningscape/Mods/EIAH.zip) (une adaptation sur les Environnements Informatiques pour l'Apprentissage Humain)
   - [Erasmus at Hogwarts](https://www.lip6.fr/Mathieu.Muratet/elearningscape/Mods/Erasmus%20at%20Hogwarts.zip) (une adaptation dans l'univers d'Harry Potter pour travailler l'anglais)
   - [ESCAPAID](https://www.lip6.fr/Mathieu.Muratet/elearningscape/Mods/ESCAPAID.zip) (une adaptation sur l'aide aux premiers secours)
   - [LaCommunication](https://www.lip6.fr/Mathieu.Muratet/elearningscape/Mods/LaCommunication.zip) (une adaptation sur les principes de communication)
   - [LaMemoire](https://www.lip6.fr/Mathieu.Muratet/elearningscape/Mods/LaMemoire.zip) (une adaptation sur le fonctionnement de la mémoire)
   - [Prepositions](https://www.lip6.fr/Mathieu.Muratet/elearningscape/Mods/Prepositions.zip) (une adaptation sur les prépositions en anglais)
   - [ScienceForensique](https://www.lip6.fr/Mathieu.Muratet/elearningscape/Mods/ScienceForensique.zip) (une adaptation sur les sciences forensiques ou l'analyse scientifique de cas)
   - [Stop Harcelement](https://www.lip6.fr/Mathieu.Muratet/elearningscape/Mods/Stop%20Harcelement.zip) (une adaptation sur le harcelmeent scolaire)
