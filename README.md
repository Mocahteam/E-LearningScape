# Téléchargements
**Version 6.4** disponible depuis le 26/09/2021

1. [**Windows**](https://github.com/Mocahteam/E-LearningScape/releases/download/v6.4/E-LearningScape_Windows.zip)
2. [**MacOS**](https://github.com/Mocahteam/E-LearningScape/releases/download/v6.4/E-LearningScape_MacOS.zip)
3. [**Linux**](https://github.com/Mocahteam/E-LearningScape/releases/download/v6.4/E-LearningScape_Linux.zip)
