...
public class BallBoxManager : FSystem {
	...
	protected override void onProcess(int familiesUpdateCount)
    {
        ...
        if (selectedBox)
        {
            ...
            if (((f_closeBox.Count == 0 && Input.GetMouseButtonDown(0)) || (Input.GetKeyDown(KeyCode.Escape) && f_iarBackground.Count == 0) || (Input.GetButtonDown("B_Button") && f_iarBackground.Count == 0)) && (boxPadlock.activeSelf || (ballsout && !inFrontOfCamera && !selectedBall)))
            {
